...
cox_model_during <- coxph(Surv(tstart, tstop, bc_diagnosis) ~ oc_group + SmokingStatus + hrt.status + meno_status + hyster_status + bmi + tdi + AgeMenarch + yob, data = t_data_during)
...
cox_model_after <- coxph(Surv(tstart, tstop, bc_diagnosis) ~ oc_group + SmokingStatus + hrt.status + meno_status + hyster_status + bmi + tdi + AgeMenarch + yob, data = t_data_after)
...
cox_model_during_2 <- coxph(Surv(tstart, tstop, bc_diagnosis) ~ oc_group + prs + SmokingStatus + hrt.status + meno_status + hyster_status + bmi + tdi + AgeMenarch + yob, data = t_data_during)
...
cox_model_after_2 <- coxph(Surv(tstart, tstop, bc_diagnosis) ~ oc_group + prs + SmokingStatus + hrt.status + meno_status + hyster_status + bmi + tdi + AgeMenarch + yob, data = t_data_after)
...
cox_model_during_3 <- coxph(Surv(tstart, tstop, bc_diagnosis) ~ oc_group * prs + SmokingStatus + hrt.status + meno_status + hyster_status + bmi + tdi + AgeMenarch + yob, data = t_data_during)
...
cox_model_after_3 <- coxph(Surv(tstart, tstop, bc_diagnosis) ~ oc_group * prs + SmokingStatus + hrt.status + meno_status + hyster_status + bmi + tdi + AgeMenarch + yob, data = t_data_after)
